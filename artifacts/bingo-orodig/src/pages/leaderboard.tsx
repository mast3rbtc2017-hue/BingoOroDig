    ...
    <div className="min-h-screen bg-background flex flex-col text-foreground relative overflow-hidden">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 relative z-10">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent mb-4">Salón de la Fama</h1>
          <p className="text-white/60 max-w-lg mx-auto">Los jugadores más exitosos en la historia de OroDig.</p>
        </div>
            ...
            <div className="space-y-4">
                ...
                >
                  ...
                  <div className="flex-1 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-sm">{entry.totalWins} victorias</p>
                    </div>
                  </div>
              ...
              {entries?.length === 0 && (
                <div className="text-center py-20 text-white/40">
                  Aún no hay ganadores. ¡Sé el primero!
                </div>
              )}
            </div>
          )}
